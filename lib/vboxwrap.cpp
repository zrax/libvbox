...
static bool isApiCompatible(int sdkVersion, int apiVersion)
{
    static const struct { int vLow, vHigh; } compatibility[] = {
        ...
        { VBox_MAKE_VERSION(5, 2, 10), VBox_MAKE_VERSION(5, 2, 44) },

        { VBox_MAKE_VERSION(6, 0, 0), VBox_MAKE_VERSION(6, 0, 24) },

        { VBox_MAKE_VERSION(6, 1, 0), VBox_MAKE_VERSION(6, 1, 18) },
        { VBox_MAKE_VERSION(6, 1, 20), VBox_MAKE_VERSION(6, 1, 34) },
    };
